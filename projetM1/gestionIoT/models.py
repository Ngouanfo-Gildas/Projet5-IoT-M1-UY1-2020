...
class Proprietaire(models.Model):
    ...
    telephone_proprio = models.CharField(max_length = 15, verbose_name="Numéro de téléphone", null=False)
    avatar = models.ImageField(null=True, upload_to="avatars/", verbose_name="photo de profil")
    pays_proprio = CountryField(blank_label='(selectioner votre pays)', verbose_name="votre pays", null=False)
